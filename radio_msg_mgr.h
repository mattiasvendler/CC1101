...
struct radio_msg_mgr{
	...
	s32_t (*handle_ctrl_msg_cb)(u32_t peer, u8_t msg_type, u8_t *msg, u8_t len,void *userdata);
	u32_t time_in_state;
...
s32_t radio_msg_send(void *data,u8_t len, u8_t require_ack, void *userdata,void (*send_done_cb)(s32_t res, void *userdata));
